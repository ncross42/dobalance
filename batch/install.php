...
##### DB #####
$table_name = $wpdb->prefix.'dob_user_hierarchy';
$sql = "CREATE TABLE IF NOT EXISTS `$table_name` (
	`term_taxonomy_id` int(11) NOT NULL DEFAULT '0',
	`user_id` int(11) NOT NULL DEFAULT '0',
	`taxonomy` enum('category','hierarchy','party','union') NOT NULL DEFAULT 'category',
	PRIMARY KEY (`term_taxonomy_id`,`user_id`),
	KEY `user_id` (`user_id`,`taxonomy`)
)";
$wpdb->query($sql);
