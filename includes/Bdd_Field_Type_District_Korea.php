 ...
 * District_Korea Type
 */
//if (!class_exists('Bdd_User_Field_District_Korea')) 
if (!class_exists('Bdd_Field_Type_District_Korea')) 
{
    class Bdd_Field_Type_District_Korea extends BP_XProfile_Field_Type
    {
        ...
        ?>
            ...
            <input id="textDistrict" <?php echo $html; ?> readonly>
