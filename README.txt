...
3. Select `dobalance.zip` from your computer
4. Click 'Install Now'
5. Activate the plugin in the Plugin dashboard

= Using FTP =

1. Download `dobalance.zip`
2. Extract the `dobalance` directory to your computer
3. Upload the `dobalance` directory to the `/wp-content/plugins/` directory
